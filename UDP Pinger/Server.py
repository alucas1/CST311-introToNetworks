...
while True:
    ...
    # Convert message to uppercase per requirements
    modifiedmessage = message.decode().upper()
    # Notify console that message was received and print message to console
    print(modifiedmessage + ' RECEIEVED')
    print('Mesg rcvd: ' + message.decode())
    # Send modifiedmessage to server and print to console the modified message was sent
